...
<p>Performers older than the selected age in the database are as follows: </p>

<table>

<tr> <th> ID </th> <th> NAME </th> <th> GENDER </th> <th> AGE </th> <th> NATIONALITY </th> </tr> 
...
$sql_statement = "SELECT * FROM performers WHERE performer_age > $selection_id ORDER BY -performer_age";
...
while($row = mysqli_fetch_assoc($result))
{
  ...
  $gender = $row['gender'];
  $age = $row['performer_age'];
  $nationality = $row['nationality'];




	echo "<tr>" . "<th>" . $performer_id . "</th>" .
     "<th>" . $name . "</th>" .
     "<th>" . $gender . "</th>" .
      "<th>" . $age  . 
