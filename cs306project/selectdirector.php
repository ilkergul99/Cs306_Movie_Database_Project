...
<html>
<head>
	<title>Directors by Nationality</title>
  <meta charset="utf-8">
...
<p>Directors by selected Nationality in the database are as follows: </p>
<table>
...
$selection_id = $_POST['countries'];

$sql_statement = "SELECT * FROM directors WHERE nationality = '$selection_id'";
