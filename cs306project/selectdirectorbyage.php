...
<p>Directors older than the selected age in the database are as follows: </p>

<table>

<tr> <th> ID </th> <th> NAME </th> <th> AGE </th> <th> GENDER </th> <th> NATIONALITY </th> </tr> 

<?php

include "config.php";

$selection_id = $_POST['points'];

$sql_statement = "SELECT * FROM directors WHERE director_age > $selection_id ORDER BY -director_age";
